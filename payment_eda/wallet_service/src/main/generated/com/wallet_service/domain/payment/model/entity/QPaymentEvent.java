...
public class QPaymentEvent extends EntityPathBase<PaymentEvent> {
    ...
    private static final long serialVersionUID = 238754522L;
    ...
    public final EnumPath<com.wallet_service.domain.payment.enums.PaymentEventMethod> method = createEnum("method", com.wallet_service.domain.payment.enums.PaymentEventMethod.class);
    ...
    public final EnumPath<com.wallet_service.domain.payment.enums.PaymentEventType> type = createEnum("type", com.wallet_service.domain.payment.enums.PaymentEventType.class);
