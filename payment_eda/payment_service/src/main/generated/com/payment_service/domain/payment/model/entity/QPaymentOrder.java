...
public class QPaymentOrder extends EntityPathBase<PaymentOrder> {
    ...
    private static final long serialVersionUID = -1291618725L;
    ...
    public final com.payment_service.domain.seller.model.entity.QSeller seller;

    public final EnumPath<com.payment_service.domain.payment.enums.PaymentOrderStatus> status = createEnum("status", com.payment_service.domain.payment.enums.PaymentOrderStatus.class);
    ...
    public QPaymentOrder(Class<? extends PaymentOrder> type, PathMetadata metadata, PathInits inits) {
        ...
        this.seller = inits.isInitialized("seller") ? new com.payment_service.domain.seller.model.entity.QSeller(forProperty("seller")) : null;
    }
