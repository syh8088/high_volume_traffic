package com.payment_service.config.feign;
...
public class FeignResponseUtils {
    public static String getRequestBody(Response response) {
        ...
        try {
            ...
            log.info(format("feign request body converting error - response: %s", response), e);
            return "";
        }
    }
    ...
    public static String getResponseBody(Response response) {
        ...
        try (InputStream responseBodyStream = response.body().asInputStream()) {
            ...
            log.info(format("feign response body converting error - response: %s", response), e);
            return "";
        }
    }
}