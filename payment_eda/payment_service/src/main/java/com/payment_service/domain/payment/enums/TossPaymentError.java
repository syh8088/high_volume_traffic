...
public enum TossPaymentError {
    ...
    // 혹시나 예측할 수 없는 다른 에러들도 올 수 있으니까 unknown 이라는 에러 코드 추가
    ...
    /**
     * 재시도가 불가능한 명백한 실패한 결제인지 체크
     */
    public boolean isFailure() {
        return this != ALREADY_PROCESSED_PAYMENT &&
                this != UNKNOWN &&
                this != UNKNOWN_PAYMENT_ERROR &&
                this != PROVIDER_ERROR &&
                this != CARD_PROCESSING_ERROR &&
                this != FAILED_INTERNAL_SYSTEM_PROCESSING &&
                this != FAILED_PAYMENT_INTERNAL_SYSTEM_PROCESSING;
    }
